...
The flashed image may be a few releases behind by the time you download it —
that's expected, not a bug. Once setup finishes, the board offers (or
auto-applies, if you enable that) the newest release over the air.
